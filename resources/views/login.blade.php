    ...
    <div class="w-screen h-screen bg-cover bg-center" style="background-image: url('./img/bg.jpg')">
        ...
        <div class="flex flex-col lg:flex-row w-full h-full">
            ...
            <div
                ...
                <h1 class="font-bold text-2xl lg:text-3xl">Login to your Account</h1>
                <div class="w-full h-auto flex flex-col gap-4">

                    <form class="w-full h-fit flex flex-col items-center gap-4" action="/login" method="post">
                        @csrf
                        ...
                        <button
                            class="w-1/3 py-4 rounded-xl font-bold bg-yellow-300 border-yellow-300 border-2 hover:bg-transparent transition-all"
                            type="submit">Login</button>

                    </form>
                    <p>Don't have an account?<a href="/register" class="underline text-yellow-300"> Register Now</a></p>
                </div>
